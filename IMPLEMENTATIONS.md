...
|------------|--------|:-------:|------|---------|
| **OpenOBA (reference)** | Node.js, @openoba/erdl engine | 16/16 | 2026-09-17 | [runner.mjs](reference/runner.mjs) |
...
Submissions for a previous vector set — not cross-verified against the current 16 vectors:

- **RavindraAnnam** — Python 3, spec-only (std lib only) — 3/8 (2026-09-10): the three pilot vectors (AV-01/04/06) cross-verified against the 3-pilot set; the set has since expanded (8 → 16). Artifact: [output.json](submissions/archive/ravindra-annam-python-independent-output.json)
